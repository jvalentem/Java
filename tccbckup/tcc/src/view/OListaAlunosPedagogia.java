 ...
 * @author thayn
 */
public class OListaAlunosPedagogia extends javax.swing.JDialog {

    /**
     * Creates new form oListaAlunos
     */
    public OListaAlunosPedagogia() {
    ...
    private void initComponents() {
        ...
        label6.setText("Lista de Alunos (PEDAGOGIA)");
    ...
    private void btn_deletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deletarActionPerformed
        DeletarAluno telaDeletarAluno = new DeletarAluno();
        telaDeletarAluno.setVisible(true);
        telaDeletarAluno.addWindowListener(new WindowAdapter(){
           @Override
           public void windowClosed(WindowEvent e){
               try{
                   ...
                   statusMessage.setText("DELETAR ALUNOS: Erro ao carregar a lista de alunos");
    ...
    private void btn_cadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastroActionPerformed
        ...
        telaCadastroAluno.addWindowListener(new WindowAdapter(){
            @Override
            public void windowClosed(WindowEvent e){
                try{
                    setListaAluno();
                }catch(Exception err){
                    System.out.println("CADASTRO: erro ao atualizar a lista de alunos");
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        BuscarIdAluno telaBuscaId = new BuscarIdAluno();
        telaBuscaId.setVisible(true);
        telaBuscaId.addWindowListener(new WindowAdapter(){
            @Override
            public void windowClosed(WindowEvent e){
                try{
                    setListaAluno();
                }catch(Exception err){
                    System.out.println("EDIÇÃO: erro ao carregar a lista de alunos");
                    statusMessage.setText("EDITAR ALUNOS: Erro ao carregar a lista de alunos");
                }
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OListaAlunosPedagogia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
