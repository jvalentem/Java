 ...
 * @author aluno
 */
public class TelaLoginCoordenador extends javax.swing.JDialog {
    ...
    private void logar(){
        ...
        String usuario = input_usuario.getText().replace(" ", "");
        String senha = input_senha.getText().replace(" ", "");
        Autenticacao autenticacao = new Autenticacao();
        
        if(autenticacao.loginPedagogia(usuario, senha)){
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginCoordenador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
