 ...
 * @author aluno
 */
public class TelaLoginPedagogia extends javax.swing.JDialog {

    /**
     * Creates new form inicio
     */
    public TelaLoginPedagogia() {
        initComponents(); //inicia os componentes da interface
        setResizable(false); //impede que a janela seja redimensionada
        setLocationRelativeTo(null); //centraliza a interface
    }
    ...
    private void logar(){
        ...
        String usuario = input_usuario.getText().replace(" ", ""); //pega o input e tira os espaços em branco
        String senha = input_senha.getText().replace(" ", "");
        Autenticacao autenticacao = new Autenticacao();
        
        if(autenticacao.loginPedagogia(usuario, senha)){ //retorna verdadeiro se a autenticacao for realizada
                this.dispose();
    ...
    private class TextFieldHandler implements KeyListener{
        ...
        public void keyPressed(KeyEvent e) { 
         if(e.getKeyCode() == KeyEvent.VK_ENTER){ //retorna true se a tecla pressionada for enter
             logar();
         }   
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginPedagogia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
